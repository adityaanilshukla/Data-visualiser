...
function drawXAxisTickLabelDate(value, layout, mapFunction, Datestring) {
  // Map function must be passed with .bind(this).
  var xPosition = mapFunction(value);
  fill(0);
  noStroke();
  textAlign("center", "center");
  ...
  // Add tick label.
  textSize(14);
  text(Datestring, xPosition, layout.bottomMargin + layout.marginSize / 2);
  textSize(16);

  if (layout.grid) {
    // Add grid line.
    stroke(220);
    line(xPosition, layout.topMargin, xPosition, layout.bottomMargin);
  }
}
